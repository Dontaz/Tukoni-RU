#define MyAppName "Русификатор для Tukoni Forest Keepers"
#define MyAppVersion "1.0"
#define MyAppPublisher "Dontaz"
#define MyAppURL "https://github.com/Dontaz/Tukoni-RU"
#define MyAppBoosty "https://boosty.to/dontaz"
#define MyAppDonationAlerts "https://www.donationalerts.com/r/dontaz"
#define GameName "Tukoni Forest Keepers"

[Setup]
AppId={{9F3D71A2-6C48-4E9B-B215-7A3F91C2TFKP}
AppName={#MyAppName}
...
OutputDir=C:\Users\user\Desktop\Programs\Unreal Engine Modding\UnrealPak\Tukoni
OutputBaseFilename=Русификатор для Tukoni Forest Keepers
...
UninstallDisplayName=Удаление русификатора Tukoni Forest Keepers
UninstallFilesDir={app}\Удаление русификатора
WizardImageFile=sidebar.png
WizardSmallImageFile=small.png
WizardImageFileDynamicDark=sidebar.png
...
[Files]
Source: "C:\Users\user\Desktop\Programs\Unreal Engine Modding\UnrealPak\Tukoni\Installer\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs

[CustomMessages]
WelcomeTitle=Вас приветствует мастер установки русификатора Tukoni Forest Keepers
...
VisitLink=🌐 Найти самую актуальную версию (GitHub)
